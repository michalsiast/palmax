<div class="section page-banner-section" style="background-image: url({{ renderImage($pageName->galleryCover(), 1800, 400, 'cover') }})">
    <div class="shape-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="944px" height="894px">
            <defs>
                <linearGradient id="PSgrad_0" x1="88.295%" x2="0%" y1="0%" y2="46.947%">
                    <stop offset="0%" stop-color="#ff5538" stop-opacity="1" />
                    <stop offset="100%" stop-color="#ff5538" stop-opacity="1" />
                </linearGradient>
            </defs>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="page-banner text-center">
                        @if(!empty($pageName2) && $pageName2 === 'Nasze realizacje')
                            <h2 class="title">{!! $pageName->title !!}</h2>
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            @endif
                            @if(!empty($pageName2) && $pageName2 === 'Nasze realizacje')
                                <li class="breadcrumb-item active" aria-current="page">{!! $pageName->title !!}</li>
                            @elseif($pageName === $page)
                                <li class="breadcrumb-item active" aria-current="page">{!! $pageName->name !!}</li>
                            @endif
                        </ul>
                    </div>
