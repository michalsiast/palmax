                ...
                <div class="about-content-wrap" style="padding-top: 0px">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="about-img-wrap">
                                <div class="about-img about-img-big">
                                    <iframe width="100%" style="border-radius: 20px" height="350" src="https://www.youtube.com/embed/LYtYO2ibab4?si=yY3hnFGSJdgMs5DK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                </div>
                            </div>
                            <!-- About Image Wrap End -->
                        </div>
